...
GOALS_COLLECTION_ID = os.getenv('APPWRITE_GOALS_COLLECTION_ID')
CATEGORY_COLLECTION_ID = os.getenv('APPWRITE_CATEGORY_COLLECTION_ID')
CURRENCY_COLLECTION_ID = os.getenv('APPWRITE_CURRENCY_COLLECTION_ID')
BUDGETING_COLLECTION_ID = os.getenv('APPWRITE_BUDGETING_COLLECTION_ID')
...
BUDGETSUMMARY_COLLECTION_ID = os.getenv('APPWRITE_BUDGETSUMMARY_COLLECTION_ID')
